...
echo "<select name = 'companyname' id = 'companyname' onclick = 'populatecomp()' disabled > "; //populate method is called to fill hidden inputbox on form with the selected company id 
...
while ($row = mysqli_fetch_array($result))
{
	...
	$theID = "$id";
	echo "<option value = '$theID'>$comp</option>"; // Company names in listbox 
}
echo "</select>";
mysqli_close($con);
?>